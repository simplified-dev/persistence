 ...
 * stored as a JSON column. {@link GsonValueType.Registrar} automatically discovers annotated
 * types in entity fields and registers a {@link GsonValueType} per unique class - no per-field
